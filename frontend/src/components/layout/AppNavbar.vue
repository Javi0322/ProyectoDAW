<template>
  <aside class="fixed left-0 top-0 h-screen w-14 shrink-0 flex flex-col items-center py-3 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 z-20">
    <!-- Logo -->
    ...
    <div class="flex flex-col items-center gap-2 shrink-0">
      ...
      >
        ...
        />
        <span v-else class="text-xs font-bold text-brand-primary leading-none">
          {{ userInitial }}
        </span>
        <!-- Tooltip -->
        <span class="pointer-events-none absolute left-full ml-2 px-2 py-1 rounded-md bg-zinc-900 dark:bg-zinc-700 text-white text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
...
// Resetear error cuando cambia el avatar (nueva subida)
